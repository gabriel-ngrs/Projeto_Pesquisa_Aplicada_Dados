...
# --------------------------
df = pd.read_excel("C:\Programacao\Projeto Pesquisa Aplicada - Análise de Dados/analise-2017/7o-ciclo-base-de-dados-2019-2-semestre.xlsx")
...
# --------------------------
final_df.to_csv("csv_2017", index=False)
