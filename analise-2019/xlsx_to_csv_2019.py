...
# --------------------------
df = pd.read_excel("C:\Programacao\Projeto Pesquisa Aplicada - Análise de Dados/analise-2019/7o-ciclo-base-de-dados-2019-2-semestre (1).xlsx")
...
# --------------------------
final_df.to_csv("csv_2019", index=False)
